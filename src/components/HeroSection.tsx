  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#F7EBDD] border-b border-[#E9D1B5]/60">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[#F7EBDD]/15 pointer-events-none" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10 px-4 sm:px-6 md:px-8">
        <div className="relative w-full flex flex-col md:flex-row items-center md:items-end justify-between min-h-[440px] sm:min-h-[480px] md:min-h-[530px] lg:min-h-[570px] pt-4 sm:pt-6 pb-0">
          ...
          <div className="w-full md:w-[48%] lg:w-[45%] flex items-end justify-center md:justify-start relative z-20 pb-0 animate-slide-in-left">
          ...
          <div className="w-full md:w-[52%] lg:w-[55%] flex flex-col items-center text-center z-10 pt-4 sm:pt-6 pb-8 sm:pb-12 md:pb-16 lg:pb-20 md:pr-4 lg:pr-8 animate-slide-in-right">
