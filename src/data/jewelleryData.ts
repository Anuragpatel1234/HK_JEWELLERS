...
export const STORIES: StoryItem[] = [
  {
    ...
    tagline: 'The kingdoms understood her authority with greater ease than some men do today.',
    image: '/assets/story/eeeerr.jpeg',
  ...
  },
  {
    id: 'afsana',
    hindiTitle: 'अफ़साना',
    englishSub: 'Afsana Earrings',
    tagline: 'Trust and love are wonderful, but don\'t forget the earrings.',
    image: '/assets/story/earrings.jpeg',
    description: 'Honoring centuries-old antique craftsmanship, elephant-motif jhumkas with Basra pearl cascades symbolizing regal heritage and romantic allure.',
  },
  {
    id: 'chhankaar',
    hindiTitle: 'छनकार',
    englishSub: 'Chhankaar',
    tagline: 'Grace begins where the payal sings.',
